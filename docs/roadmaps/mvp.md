...
| **GS**   | Rule L3–L6 chain complete; thesis summary display done | 2nd domain chain (2GS.7) | —          |
| **UI**   | StatusBar, ChoiceList, save/load, idea panel, thesis summary overlay | Thesis panel (2UI.2) | —                       |
