...
The setting and context that makes the objects, ideas, and recipes cohere. Everything in the game should feel like it belongs to this world.
...
- **Show, don't tell.** The world is communicated through objects and their descriptions, not through exposition. The player assembles the world from details.
- **Ambiguity is a feature.** The player should be able to infer multiple things about the Writer and the world from the same object. Don't over-determine.
